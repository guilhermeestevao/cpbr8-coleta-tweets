...
public class ServletColetaTweets extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		File raiz = new File("C:\\Users\\Alex Oliveira\\Desktop");
		...
		BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\Alex Oliveira\\Desktop\\info.txt", true));
		...
		bw.write("Data de criação: "+format.format(busca.getDataCriacao()));
		bw.write("\n");
